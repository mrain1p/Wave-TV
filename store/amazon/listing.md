...
internet radio server. Enter the address of a SUB/WAVE server you run or have
been given access to, and Wave TV gives it a native Fire TV interface: a
...
on a Fire TV and makes it work from the remote.
